...
import type ReaderCommentsSheet from "../components/ReaderCommentsSheet";

export function usePageCommentsSheet({
  pageId,
  pageNumber,
  commentCount,
  sentences,
...
}): Omit<ComponentProps<typeof ReaderCommentsSheet>, "onClose" | "pageNumber"> {
